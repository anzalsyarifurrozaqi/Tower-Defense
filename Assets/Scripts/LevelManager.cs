...
public class LevelManager : MonoBehaviour {
    ...
    private void Update() {
        ...
        foreach (Enemy enemy in _spawnedEnemies) {
            ...
            if (Vector2.Distance(enemy.transform.position, enemy.TargetPosition) < 0.1) {
    ...
    private void SpawnEnemy()
    {
        ...
        Enemy newEnemy = newEnemyObj.gameObject.GetComponent<Enemy>();
    ...
    {
        _currentLives = Mathf.Max(currentLives);
